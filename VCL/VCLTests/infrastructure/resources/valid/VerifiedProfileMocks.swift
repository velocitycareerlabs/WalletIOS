...
class VerifiedProfileMocks {
    ...
    static let VerifiedProfileIssuerInspectorJsonStr =
    ...
    static let VerifiedProfileIssuerJsonStr =
    ...
    static let VerifiedProfileNotaryIssuerJsonStr =
    ...
    static let VerifiedProfileInspectorJsonStr =
